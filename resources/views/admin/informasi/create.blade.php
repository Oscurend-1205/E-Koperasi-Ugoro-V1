...
@section('title', 'Tulis Informasi — Koperasi Ugoro')
  ...
  <div class="canvas">
    ...
    <div class="page-header">
      <div style="display:flex; align-items:center; gap:12px;">
        <span class="material-symbols-rounded" style="font-size:28px; color:var(--green)">edit_square</span>
        <div>
          <h2 style="font-size:18px; font-weight:800;">Tulis Informasi Baru</h2>
          <p style="font-size:11px; color:var(--text-muted);">Buat pengumuman atau informasi untuk ditampilkan di dashboard anggota</p>
        </div>
      </div>
    </div>
    ...
    <form action="{{ route('admin.informasi.store') }}" method="POST" id="composerForm">
      @csrf
      <div class="card">
        <div class="card-header">
          <div class="card-title">
            <span class="material-symbols-rounded" style="color:var(--green)">edit_note</span>
            Compose
          </div>
        ...
        <div class="composer-body">
          <div class="form-group">
            <input type="text" name="title" class="title-input" placeholder="Judul informasi..." value="{{ old('title') }}" required/>
          </div>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <select name="category" class="form-input" required>
                ...
                <option value="Penting" {{ old('category') == 'Penting' ? 'selected' : '' }}>Penting</option>
            ...
            <div class="form-group" style="justify-content:flex-end;">
              <div class="options-row" style="margin-top:auto;">
                <div class="toggle-wrap">
                  <input type="checkbox" name="is_pinned" value="1" class="toggle" id="togglePin" {{ old('is_pinned') ? 'checked' : '' }}/>
                  <label for="togglePin">📌 Pin di atas</label>
                </div>
                <div class="toggle-wrap">
                  <input type="checkbox" name="is_active" value="1" class="toggle" id="toggleActive" checked/>
          ...
          @include('admin.informasi._editor')
        </div>

        <div class="composer-footer">
          <div class="char-count" id="charInfo">Siap menulis...</div>
...
<script>
  ...
  function updateInfo() {
    ...
    charInfo.textContent = `${chars} karakter · ${words} kata` + (imgs ? ` · ${imgs} gambar` : '');
  }
  if (editorEl) {
