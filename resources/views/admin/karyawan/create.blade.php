...
<title>Admin - Tambah Struktur — Koperasi Ugoro</title>
    ...
    <div class="card">
      <form action="{{ route('karyawans.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input name="name" class="form-control" placeholder="Masukkan nama lengkap..." required type="text"/>
        </div>

        <div class="grid-2">
          <div class="form-group">
            <label>Jabatan</label>
            <input name="position" class="form-control" placeholder="Contoh: Ketua Koperasi, Admin IT..." required type="text"/>
          </div>
          <div class="form-group">
        ...
        <div class="grid-2">
          <div class="form-group">
            ...
            <input name="nip" class="form-control" placeholder="Contoh: 1980... / EMP-001" type="text"/>
          </div>
          <div class="form-group">
            <label>Status</label>
        ...
        <div class="form-group">
          ...
          <input name="order_num" class="form-control" type="number" value="1" required/>
        </div>

        <div class="form-group">
          <label>Bio / Keterangan Singkat</label>
          <textarea name="bio" class="form-control" rows="3" placeholder="Masukkan bio jika ada..."></textarea>
        </div>
        ...
        <div style="margin-top:12px; display:flex; justify-content:flex-end;">
          <button class="btn btn-primary" type="submit" style="padding:12px 32px;">Simpan Data</button>
        </div>
      </form>
    </div>
  </div>
